...
long long int EfficientBubbleSort(int*, int);
...
int main()
{
	...
	//Open file
	myfile.open("BubbleEfficient.txt", ios::out | ios::ate | ios::app);
...
//        cout << endl;
		...
		basic = EfficientBubbleSort(A, size);
...
long long int EfficientBubbleSort(int *A, int size)
{
